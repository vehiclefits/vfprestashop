...
INSERT INTO `elite_1_definition` (`id`, `make_id`, `model_id`, `year_id`, `service_code`) VALUES
(1, 1, 1, 1, '');
...
INSERT INTO `elite_1_mapping` (`id`, `make_id`, `model_id`, `year_id`, `entity_id`, `universal`, `related`, `price`) VALUES
(2, 1, 1, 1, 1, 0, 0, 0);
...
INSERT INTO `elite_level_1_make` (`id`, `title`) VALUES
(1, 'Honda_Unique5206b60a8a554');
...
INSERT INTO `elite_level_1_model` (`id`, `title`) VALUES
(1, 'Civic');
...
INSERT INTO `elite_level_1_year` (`id`, `title`) VALUES
(1, '2002');
